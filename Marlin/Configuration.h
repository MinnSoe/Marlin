...
#define MACHINE_UUID "677d68c3-5c6b-4455-a0a1-70506524d7d4"
 ...
 * Override with M92
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 * X = (5 turns per inch * (1/1/16) * 200 steps per turn) / 25.4 mm per inch
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -19.1 }
...
#define HOMING_FEEDRATE_XY (8*60)
